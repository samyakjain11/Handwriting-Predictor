...
class ModelInterpretor {
 public:
   ...
   * @param classification the specific classification for whihc you are calculating likelihood
 ...
 private:
  ...
  /**
   * represents the calculated likelihoods of a specific pixel being shaded given its class
   */
